...
point faible particulier, et capacité bonus à transmettre au joueur,
...
<img alt="30min timer" src="timer-30.svg" title="30min">

:::: row
::: scenario
![](a_bottomless_sea_by_sunnyclockwork_daot7gy-fullview.jpg)
## Cthulhu fhtagn
...
1. une pièce a priori vide, en réalité un trompe-l'oeil dissimulant un coffre
...
et se réincarne dans un autre soldat précédement assoupi. Le temps défile en continu, il n'y a pas de retour en arrière,
...
- un vaisseau spatial titanesque, mi organique mi technologique, ou des insectes géants cotoient des [mechas](https://fr.wikipedia.org/wiki/Mecha) extra-terrestres
### Obstacles
...
::: scenario
![](sotc_christmas_shirt_design_by_fritz6_d1e07il-pre.png)
## La chute du colosse
...
:::: row
::: scenario
![](sam_fisher_by_thesimplylexi_d8fs642-fullview.jpg)
...
De plus, vous disposez d'une arme à feu avec silencieux et d'un implant "oracle" à la nuque,
vous permettant de générer une simulation précise du futur immédiat, avec une autonomie de 30min.
Dans ce scénario, chaque fois qu'une joueur meurt, c'est qu'il s'agissait d'une simulation de l'implant "oracle".
### Environnement
- l'ambassade est une belle résidence de style colonial à 2 étages, avec un escalier central grinçant, et entourée d'un petit jardin tropical :
  * Au rez-de-chaussé : salle de réception, cuisine, salle de bain
  * Au 1er étage : bibliothèque, bureau de l'ambassadeur, sa chambre, celle de sa fille
  * Au 2 étage : buanderie, chambre de la gouvernante, chambre / poste de surveillance d'un garde, grenier
...
### Conseils au MJ
Si les dés ne permettent aux joueurs ni d'emmployer le cable électrique ni le parachute,
laissez-le descendre au sol en rappel, sans faire de jet.

Essayez de permettre aux joueurs d'accéder à l'ordinateur dans le temps imparti,
mais rendez leur fuite difficile (sans être impossible) :
ils peuvent ainsi réussir l'objectif mais ne pas s'échapper à temps, justifiant les prémisses du scénario suivant.
### Rejouer le scénario
Agrandissez l'ambassade, changez la position des pièces et rajoutez des gardes.
:::

::: scenario
![](soldier1_by_thesimplylexi.jpg)
...
> Votre implant "oracle" est toujours dans votre nuque, mais a été sectionné.
> Depuis plusieurs jours, le docteur Koenig expérimente des drogues sur des soldats capturés, qui ont succombés un par un.
> Aujourd'hui, c'est votre tour.
> Deux mercenaires vous escortent, ligoté, jusqu'au laboratoire, où il vous attachent à une chaise.
> Sans un mot, Koenig s'approche de vous et vous injecte un liquide noir et épais.
> Une immense douleur vous parcoure, mais contre toute attente, vous survivez.
> Vous sentez votre corps assimiler et réactiver l'implant "oracle",
> et un étrange instinct se réveiller, une envie pressante de **toucher** de la main vos congénères...
### Objectif
Vous évader du campement des narcos.
### Inspirations
> Les jeux vidéos Metal Gear Solid, Prototype & Splinter Cell.
### Règle spéciale
À chaque _run_, le joueur actif bénéfice d'un bonus d'**adrénaline**, fournissant **+2** au résultat du dé,
qu'il peut employer une unique fois.

La première fois qu'Alex touchera un humain, il l'**assimilera** :
- il aspire via sa main une partie des organes internes, cerveau compris, de sa victme
...
Après cette expérience, les joueurs auront tout contrôle d'assimiler ou non leurs adversaires.
Uniquement s'il a l'idée d'essayer, Alex se révelera également capable de fouiller la mémoire de ses victimes.
### Environnement
- 
- le labo contient des documents estampillés "Gentek"
- le bunker souterrain est constitué d'un couloir central débouchant vers le sas de sortie,
et quatre pièces, toutes sécurisées par un même digicode : une geôle désormais vide, le labo servant aux expérimentations du « docteur »,
un atelier / garage et un dortoir.
- à l'ex
...
- « docteur »
- scanner rétinien
Reste-il d'autres prisonniers ?
### Conseils au MJ
Essayer de doser la difficulté pour que les joueurs s'échappent du bunker au 2/3 du scénario (à ~20min).

Si la situation s'y prête, plutôt que de tirer aléatoirement la nouvelle capacité spéciale d'Alex,
choisissez celle qui convient le mieux à la situation : si Alex a un couteau en main par exemple,
il l'absorbe at obtient la capacité de générer un lame !
### Rejouer le scénario
...
:::: row
::: scenario
![](adaption_by_themefinland_dc1fe8g-fullview.jpg)
## Spec Ops #3 - REVENGEANCE
> L'heure de la vengeance à sonnée.
> Vous allumez tranquillement une cigarette, au pied du gratte-ciel habritant les bureaux et laboratoires de Gentek,
...
### Règles spéciales
+1 **définitivement** aux prochains jets par adversaire absorbé, + acquisition d'une capacité spéciale au hasard :

Face au boss, capacité de retour temporel annulé !
MAIS le combat se prolonge, round par round... une vie par joueur
### Environnement
- hall d'entrée très vide et épuré, dans le style "temple grec".Au bout d'une longue série de colonnes, une réceptionniste trône à son bureau.
- l'immeuble fait 18 étages, les 16e & 17e étant complètement oppaques, et le 18e abritant le bureau d'Oslow
- sur le côté du gratte-ciel, un laveur de vitre
- dernier étage sans cloisons, une seule grande pièce vitrée au milieu de laquelle trône un bureau,
et assis derrière : Glenn Oslow
### Obstacles
- un duo de vigiles en costard, armés de revolvers
- drones
- des escouades de 3 à 5 mercenaires lourdement armés,
et équipés de _geno-scanners_ : des appareils permettant d'identifier génétiquement une personne par simple 
- le boss final est constitué de Glenn Oslow et son garde du corps ninja-cyborg :
chacun nécessite d'obtenir un résultat de 10 minimum en combinant dé & bonus
### Conseils au MJ
Ajustez la difficulté du boss final en fonction du temps restant et du nombre d'absorptions déjà effectuées.
### Rejouer le scénario
L'alerte a été donné avant l'arrivée d'Alex : la zone ne comporte plus que des hommes armés et prévenus de sa présence.
Vous pouvez aussi faire intervenir un hélicoptère avec mitrailleuses, façon Matrix, 
:::

::: scenario
![](hitman___absolution_by_evandeciren_d5d6oc6.jpg)
## Hitman
...
Petit conseil dramatique : lorsque le chronomètre s'arrête,
prévenez les joueurs que cela n'interrompt pas le _run_ en cours,
mais que c'est leur dernière chance de réussir !

Un grand merci aux playtesteurs : Simon, Matthieu, Henri, Nicolas, Etienne, Thomas, Martin, Pierre,
ainsi que les joueurs qui ont testé ces scénarios à la [CyberConv](http://www.cyberconv1.com) :
...
- [Antü Plasma Suite by Fabián Alexis](https://commons.wikimedia.org/wiki/File:Antu_org.kde.plasma.timer.svg) - CC BY-SA 3.0
...
img { display: block; margin: 0 auto; max-width: 90%; max-height: 30rem; }
