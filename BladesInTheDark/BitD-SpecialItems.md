...
![](img/BitD-Artworks-Binocular-by-Tensei.jpg)
...
![](img/BitD-Artworks-PistoletHarpon-by-Tensei.jpg)
...
![](img/BitD-Artworks-Journal-by-Tensei.jpg)
...
![](img/BitD-Artworks-Horizon-by-Tensei.jpg)
...
![](img/wtactics-HumanItemSet-MasterGhostKey.png)
...
![](img/BitD-Artworks-SmokeGun-by-Tensei.jpg)
...
![](img/DirQuest-potion14.png)

## Sérum _physicker_<br>requin-démon
...
![](img/HeartOfKotar-Dishonored-noBg.png)
...
![](img/mist-ghost-mask-noBg-bw.png)

## Masque<br>d'os de Léviathan

:::

::: item

![](img/Mist-cross-pendant-noBg.png)
...
![](img/MasqueAuxMillesVisages-noBg.png)
...
.item.small-img img  { max-height: 6rem; }
.item.medium-img img { margin-top: 0; max-height: 10rem; }
.item.large-img img  { margin-top: 0; max-height: 12rem; max-width: 12rem; }
.item p {
  font-size: .8rem;
  line-height: .8rem;
  text-align: center;
...
.item.long-text img { margin-top: 0; }
.item.long-text h2 { margin: .5rem auto; }
.item.long-text p { margin: 0 auto; }
</style>
