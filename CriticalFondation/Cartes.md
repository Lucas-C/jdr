...
:::
::: description
**L'agent à ta droite t'a déjà sauvé la vie**.

Détermine comment : lors d'une mission ?
Ou dans la vie "civile" ?
Quelle était le danger : couteau, sniper, voiture, alcool, dépression ?

En partie, fais-y allusion, et n'oublie pas la dette que tu as envers cet agent.
:::
::::
:::: card intel
::: name
...
:::
::: description
**L'agent à ta droite t'agace**.

Détermine pourquoi : est-ce que tu le trouves trop pointilleux ?
Trop inexpérimenté ? Pas assez réactif ?
Ou bien est-ce à cause d'une de ses manies ?

En partie, fais des blagues et des petites remarques pour exprimer cet agacement.
:::
::::
:::: card intel
::: name
...
:::
::: description
**L'agent à ta droite t’impressionne.**.

Détermine ce pourquoi tu l'admires : est-ce son charme ?
Ses talents hors du commun ?
Sa détermination ? Son instinct ? Son sang-froid ?

En partie, exprime cette admiration de la manière que tu souhaites.
:::
::::
:::: card intel
::: name
...
:::
::: description
**L'agent à ta droite stimule ton esprit de compétition**.

Détermine les domaines où tu ressens le besoin de prouver que tu es meilleur que lui : enquête ? Interrogatoire ? Nombre d'adversaires KO ?

En partie, ne rate jamais une occasion de le surpasser.
:::
::::
::::: <!-- end of .cards -->
...
Cette aide de jeu de Lucas Cimon a été publiée en octobre 2025 et est placée sous licence <a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.fr">Creative Commons Attribution-NonCommercial6ShareAlike 4.0 International</a>.
