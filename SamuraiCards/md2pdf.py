...
METADATA = {
    CARDS_MD_FILEPATH: {
        ...
        "prefix": "SamuraiCards-",
        "title": "Samurai Cards",
        "keywords": ("jdr", "jeu-de-rôle", "cartes"),
        "description": "Un jeu de rôle à base de cartes",
    },
...
def build_single_pdf(md_filepath, metadata, lang):
    ...
    with out_filepath.open("wb") as out_pdf_file:
        out_pdf_file.write(markdown2pdf(DIR, md_filepath, CSS_FILEPATH, expected_pages_count=None, lang=lang, metadata=metadata))
