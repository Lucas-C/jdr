...
- [Acte 1 - L'oeil pour le détail](#acte-1-L-oeil-pour-le-détail)
...
* a connaissance d'une arme de contrebande planquée dans un recycleur du niveau 4.
* **Objectifs** :
* **Attitude** :
* **Mort probable** :
...
* est persuadée que l'attaque des androïdes est un coup de GEC pour mater les ouvriers suite à la révolte sur Cepheus
* sait qu'il peut y avoir du matériel utile pour se défendre dans le bureau de GEC au niveau 2
* dans sa cabine du niveau 7 il y a un emeteur-récepteur longue portée lui permettant de contacter en secret d'autres leaders syndicalistes de stations et colonies environnantes. Cela peut sembler un moyen pour demander de l'aide, mais il faudra compter plus de 16h avant d'avoir une réponse une fois un message envoyé à son contact le plus proche.
* **Objectifs** : durant les premières heures après l'attaque, elle s'efforcera de sécuriser une zone de repli au niveau 9, bien que l'androïde du poste de garde, armé, s'avère difficile à neutraliser. Ensuite :
    + sauver et rassembler un maximum de dockers et manœuvres
    + lutter contre les androïdes et reprendre la station
    + envoyer un SOS avec son récepteur
* **Attitude** : elle sera ouverte à l'entraide avec des PJs ayant des objectifs compatibles, et combatifs.
* **Roleplay** : pour 
* **Mort probable** :

### Jada Jones
<img alt="Jada Jones" src="img/ZoeWashburne-bw.jpg" class="pnj">
